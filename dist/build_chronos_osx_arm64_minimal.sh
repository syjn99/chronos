bazel build --remote_cache=http://192.168.2.200:9090 --stamp --config=minimal --config=osx_arm64 //cmd/beacon-chain //cmd/validator //cmd/prysmctl //tools/enr-calculator
if [ $? -ne 0 ]; then
