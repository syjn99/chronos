	...
	return &ethpb.BeaconBlockCapella{
		...
		Body: &ethpb.BeaconBlockBodyCapella{
			...
			ExecutionPayload: &enginev1.ExecutionPayloadCapella{
				ParentHash:    FillByteSlice(32, 114),
				FeeRecipient:  FillByteSlice(20, 115),
				StateRoot:     FillByteSlice(32, 116),
				ReceiptsRoot:  FillByteSlice(32, 117),
				LogsBloom:     FillByteSlice(256, 118),
				PrevRandao:    FillByteSlice(32, 119),
				BlockNumber:   120,
				GasLimit:      121,
				GasUsed:       122,
				Timestamp:     123,
				ExtraData:     FillByteSlice(32, 124),
				BaseFeePerGas: FillByteSlice(32, 125),
				BlockHash:     FillByteSlice(32, 126),
				Transactions: [][]byte{
					FillByteSlice(32, 127),
					FillByteSlice(32, 128),
				},
				Withdrawals: []*enginev1.Withdrawal{
					{
						Index:          129,
						ValidatorIndex: 130,
						Address:        FillByteSlice(20, 131),
						Amount:         132,
					},
					{
						Index:          133,
						ValidatorIndex: 134,
						Address:        FillByteSlice(20, 135),
						Amount:         136,
					},
				},
			},
	...
	return &apimiddleware.BeaconBlockCapellaJson{
		...
		Body: &apimiddleware.BeaconBlockBodyCapellaJson{
			...
			ExecutionPayload: &apimiddleware.ExecutionPayloadCapellaJson{
				ParentHash:    FillEncodedByteSlice(32, 114),
				FeeRecipient:  FillEncodedByteSlice(20, 115),
				StateRoot:     FillEncodedByteSlice(32, 116),
				ReceiptsRoot:  FillEncodedByteSlice(32, 117),
				LogsBloom:     FillEncodedByteSlice(256, 118),
				PrevRandao:    FillEncodedByteSlice(32, 119),
				BlockNumber:   "120",
				GasLimit:      "121",
				GasUsed:       "122",
				TimeStamp:     "123",
				ExtraData:     FillEncodedByteSlice(32, 124),
				BaseFeePerGas: bytesutil.LittleEndianBytesToBigInt(FillByteSlice(32, 125)).String(),
				BlockHash:     FillEncodedByteSlice(32, 126),
				Transactions: []string{
					FillEncodedByteSlice(32, 127),
					FillEncodedByteSlice(32, 128),
				},
				Withdrawals: []*apimiddleware.WithdrawalJson{
					{
						WithdrawalIndex:  "129",
						ValidatorIndex:   "130",
						ExecutionAddress: FillEncodedByteSlice(20, 131),
						Amount:           "132",
					},
					{
						WithdrawalIndex:  "133",
						ValidatorIndex:   "134",
						ExecutionAddress: FillEncodedByteSlice(20, 135),
						Amount:           "136",
					},
				},
			},
