		...
		Message: &structs.BlindedBeaconBlockCapella{
			...
			Body: &structs.BlindedBeaconBlockBodyCapella{
				...
				ExecutionPayloadHeader: &structs.ExecutionPayloadHeaderCapella{
					...
					CheckpointRoot:   hexutil.Encode(blindedCapellaBlock.BlindedCapella.Block.Body.ExecutionPayloadHeader.CheckpointRoot),
...
func generateSignedBlindedCapellaBlock() *ethpb.GenericSignedBeaconBlock_BlindedCapella {
	return &ethpb.GenericSignedBeaconBlock_BlindedCapella{
		BlindedCapella: &ethpb.SignedBlindedBeaconBlockCapella{
			Block: &ethpb.BlindedBeaconBlockCapella{
				...
				Body: &ethpb.BlindedBeaconBlockBodyCapella{
					...
					ExecutionPayloadHeader: &enginev1.ExecutionPayloadHeaderCapella{
						...
						CheckpointRoot:   test_helpers.FillByteSlice(32, 115),
						ReceiptsRoot:     test_helpers.FillByteSlice(32, 116),
						LogsBloom:        test_helpers.FillByteSlice(256, 117),
						PrevRandao:       test_helpers.FillByteSlice(32, 118),
						BlockNumber:      119,
						GasLimit:         120,
						GasUsed:          121,
						Timestamp:        122,
						ExtraData:        test_helpers.FillByteSlice(32, 123),
						BaseFeePerGas:    test_helpers.FillByteSlice(32, 124),
						BlockHash:        test_helpers.FillByteSlice(32, 125),
						TransactionsRoot: test_helpers.FillByteSlice(32, 126),
						WithdrawalsRoot:  test_helpers.FillByteSlice(32, 127),
					},
					BlsToExecutionChanges: []*ethpb.SignedBLSToExecutionChange{
						{
							Message: &ethpb.BLSToExecutionChange{
								ValidatorIndex:     128,
								FromBlsPubkey:      test_helpers.FillByteSlice(48, 129),
								ToExecutionAddress: test_helpers.FillByteSlice(20, 130),
							},
							Signature: test_helpers.FillByteSlice(96, 131),
						},
						{
							Message: &ethpb.BLSToExecutionChange{
								ValidatorIndex:     132,
								FromBlsPubkey:      test_helpers.FillByteSlice(48, 133),
								ToExecutionAddress: test_helpers.FillByteSlice(20, 134),
							},
			...
			Signature: test_helpers.FillByteSlice(96, 136),
		},
	}
}
