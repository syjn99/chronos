...
func (c beaconApiBeaconBlockConverter) ConvertRESTBellatrixBlockToProto(block *structs.BeaconBlockBellatrix) (*ethpb.BeaconBlockBellatrix, error) {
	...
	checkpointRoot, err := hexutil.Decode(block.Body.ExecutionPayload.CheckpointRoot)
	if err != nil {
		return nil, errors.Wrapf(err, "failed to decode execution payload checkpoint root `%s`", block.Body.ExecutionPayload.CheckpointRoot)
	}
	...
	bellatrixBlock, err := c.ConvertRESTBellatrixBlockToProto(&structs.BeaconBlockBellatrix{
		...
		Body: &structs.BeaconBlockBodyBellatrix{
			...
			ExecutionPayload: &structs.ExecutionPayload{
				...
				CheckpointRoot: block.Body.ExecutionPayload.CheckpointRoot,
	...
	return &ethpb.BeaconBlockCapella{
		...
		Body: &ethpb.BeaconBlockBodyCapella{
			...
			ExecutionPayload: &enginev1.ExecutionPayloadCapella{
				...
				CheckpointRoot: bellatrixBlock.Body.ExecutionPayload.CheckpointRoot,
