...
// Hash: f82f4ec9046a6c3e82b4e5f8bc9dfb8e1d3412ae9055f33cdd37477ead187da9
package enginev1
...
func (e *ExecutionPayloadDeneb) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (16) 'BlobGasUsed'
	dst = ssz.MarshalUint64(dst, e.BlobGasUsed)

	// Field (17) 'ExcessBlobGas'
...
func (e *ExecutionPayloadDeneb) UnmarshalSSZ(buf []byte) error {
	...
	// Field (16) 'BlobGasUsed'
	e.BlobGasUsed = ssz.UnmarshallUint64(buf[544:552])

	// Field (17) 'ExcessBlobGas'
	e.ExcessBlobGas = ssz.UnmarshallUint64(buf[552:560])
...
func (e *ExecutionPayloadHeaderDeneb) UnmarshalSSZ(buf []byte) error {
	...
	// Field (16) 'BlobGasUsed'
	e.BlobGasUsed = ssz.UnmarshallUint64(buf[600:608])

	// Field (17) 'ExcessBlobGas'
	e.ExcessBlobGas = ssz.UnmarshallUint64(buf[608:616])
