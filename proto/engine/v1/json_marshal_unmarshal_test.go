...
func TestJsonMarshalUnmarshal(t *testing.T) {
	...
	t.Run("execution payload", func(t *testing.T) {
		...
		require.DeepEqual(t, checkpointRoot, payloadPb.CheckpointRoot)
	...
	t.Run("execution payload Capella", func(t *testing.T) {
		...
		checkpointRoot := common.BytesToHash([]byte("checkpointRoot"))
		...
		require.DeepEqual(t, checkpointRoot.Bytes(), pb.Payload.CheckpointRoot)
