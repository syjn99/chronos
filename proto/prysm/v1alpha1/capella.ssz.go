...
// Hash: 73d15c56a12560d21638bd1ff2c354553abeba83d57b3f3b728cbdeef333fc25
package eth
...
func (b *BeaconStateCapella) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o9, o11, o12, o15, o16, o21, o24, o25, o28 uint64
	...
	// Field (27) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2736645:2736653]))

	// Offset (28) 'HistoricalSummaries'
	if o28 = ssz.ReadOffset(buf[2736653:2736657]); o28 > size || o25 > o28 {
		return ssz.ErrOffset
	}
