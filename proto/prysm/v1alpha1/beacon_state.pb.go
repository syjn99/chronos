...
func (x *BeaconStateOld) GetSlot() github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
	return github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Slot(0)
...
var file_proto_prysm_v1alpha1_beacon_state_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x69, 0x6e, 0x74, 0x42, 0x9b, 0x01, 0x0a, 0x19, 0x6f, 0x72, 0x67, 0x2e, 0x65, 0x74,
	0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70,
...
var file_proto_prysm_v1alpha1_beacon_state_proto_depIdxs = []int32{
	...
	2,  // 45: ethereum.eth.v1alpha1.BeaconStateOld.fork:type_name -> ethereum.eth.v1alpha1.Fork
	17, // 46: ethereum.eth.v1alpha1.BeaconStateOld.latest_block_header:type_name -> ethereum.eth.v1alpha1.BeaconBlockHeader
	18, // 47: ethereum.eth.v1alpha1.BeaconStateOld.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	18, // 48: ethereum.eth.v1alpha1.BeaconStateOld.eth1_data_votes:type_name -> ethereum.eth.v1alpha1.Eth1Data
	19, // 49: ethereum.eth.v1alpha1.BeaconStateOld.validators:type_name -> ethereum.eth.v1alpha1.Validator
	3,  // 50: ethereum.eth.v1alpha1.BeaconStateOld.previous_epoch_attestations:type_name -> ethereum.eth.v1alpha1.PendingAttestation
	3,  // 51: ethereum.eth.v1alpha1.BeaconStateOld.current_epoch_attestations:type_name -> ethereum.eth.v1alpha1.PendingAttestation
	20, // 52: ethereum.eth.v1alpha1.BeaconStateOld.previous_justified_checkpoint:type_name -> ethereum.eth.v1alpha1.Checkpoint
	20, // 53: ethereum.eth.v1alpha1.BeaconStateOld.current_justified_checkpoint:type_name -> ethereum.eth.v1alpha1.Checkpoint
	20, // 54: ethereum.eth.v1alpha1.BeaconStateOld.finalized_checkpoint:type_name -> ethereum.eth.v1alpha1.Checkpoint
