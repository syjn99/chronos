...
type BeaconValidatorClient interface {
	...
	SubmitValidatorRegistration(ctx context.Context, in *v1.SubmitValidatorRegistrationsRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *beaconValidatorClient) SubmitValidatorRegistration(ctx context.Context, in *v1.SubmitValidatorRegistrationsRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type BeaconValidatorServer interface {
	...
	SubmitValidatorRegistration(context.Context, *v1.SubmitValidatorRegistrationsRequest) (*emptypb.Empty, error)
...
func (*UnimplementedBeaconValidatorServer) SubmitValidatorRegistration(context.Context, *v1.SubmitValidatorRegistrationsRequest) (*emptypb.Empty, error) {
